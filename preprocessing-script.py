...
preprocess_negative = prc.cut_threshold(preprocess_negative, t = 500) 

m_a = prc.median_stat(t_feature_positive.describe(), preprocess_negative.describe())

preprocess_negative = prc.handle_outlier(preprocess_negative)
